...
- **숨긴 것** — 현황판에서 숨긴 선사·배·항구·지역을 한 표로 보고 되돌립니다. 이것도 브라우저에 저장되는 값입니다. [아래](#관심-없는-것-숨기기)를 보세요.
...
- **배**는 표의 별점 칸을 눌러 열리는 칸에서 **숨기기** 를 누릅니다. 이미 "이 배에 대한 내 표시"를
  고르는 칸이라 같이 뒀습니다 — 표에 버튼을 하나 더 달면 한 쪽 1200줄에 1200개가 늘어납니다.
