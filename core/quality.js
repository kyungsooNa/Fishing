...
//
// 고치는 곳이 어디냐도 같이 냅니다. 항구·전화번호는 registry에 사람이 적는 값이고,
// 출항시각·승선료·정원은 어댑터가 페이지에서 읽어오는 값입니다. 섞어 세면 registry를
// 고칠 일과 파서를 고칠 일이 한 줄에 붙어버립니다.
...
export const FIELDS = [
  ...
  { key: 'price', label: '승선료', where: 'adapter' },
